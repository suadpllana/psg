...
export const matchesInfo = [
  {
    ...
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Pacho", "Beraldo", "Zague", "Zaïre-Emery", "Vitinha", "Asensio", "Lee Kang-in", "Ramos", "Mbaye"],
  ...
  },
  {
    ...
    status: "completed",
    goals: [
      { player: "Evann Guessand", minute: 20, team: "Nice" },
      { player: "Terem Moffi", minute: 50, team: "Nice" },
      { player: "Ousmane Dembélé", minute: 70, team: "PSG" },
  ...
  },
  {
    ...
    status: "completed",
    goals: [
      { player: "Habib Diarra", minute: 30, team: "Strasbourg" },
      { player: "Emanuel Emegha", minute: 60, team: "Strasbourg" },
      { player: "Gonçalo Ramos", minute: 80, team: "PSG" }
    ],
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Pacho", "Beraldo", "Nuno Mendes", "Vitinha", "João Neves", "Lee Kang-in", "Dembélé", "Ramos", "Barcola"],
  ...
  },
  {
    ...
    goals: [
      ...
      { player: "Gideon Kalulu", minute: 70, team: "Auxerre" },
      { player: "Bradley Barcola", minute: 85, team: "PSG" }
    ],
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Marquinhos", "Pacho", "Nuno Mendes", "Vitinha", "Zaïre-Emery", "Fabián Ruiz", "Dembélé", "Ramos", "Barcola"],
  ...
  },
  {
    ...
    status: "completed",
    goals: [
      { player: "Wesley Teixeira", minute: 40, team: "Lens" },
      { player: "Marco Asensio", minute: 80, team: "PSG" }
    ],
    lineup: {
      PSG: ["Tenas", "Mukiele", "Beraldo", "Kimpembe", "Zague", "João Neves", "Lee Kang-in", "Soler", "Asensio", "Kolo Muani", "Mbaye"],
      Lens: ["Samba", "Gradit", "Khusaev", "Medina", "Chávez", "Diouf", "Thomasson", "Fulgini", "Saïd", "Sotoca", "Frankowski"]
    }
  },
  {
  ...
  },
  {
    ...
    status: "completed",
    goals: [
      { player: "Player X", minute: 30, team: "Dunkerque" },
      { player: "Randal Kolo Muani", minute: 45, team: "PSG" },
      { player: "Marco Asensio", minute: 60, team: "PSG" },
      { player: "Player Y", minute: 70, team: "Dunkerque" },
      { player: "Désiré Doué", minute: 80, team: "PSG" },
      { player: "Senny Mayulu", minute: 85, team: "PSG" }
    ],
    lineup: {
      PSG: ["Tenas", "Mukiele", "Beraldo", "Kimpembe", "Zague", "João Neves", "Lee Kang-in", "Soler", "Asensio", "Kolo Muani", "Doué"],
      Dunkerque: ["Placeholder XI"]
    }
  },
  {
    id: 40,
  ...
  },
  {
    ...
    goals: [
      ...
      { player: "Kai Havertz", minute: 70, team: "Arsenal" }
    ],
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Marquinhos", "Pacho", "Nuno Mendes", "Vitinha", "Zaïre-Emery", "Fabián Ruiz", "Dembélé", "Ramos", "Barcola"],
  ...
  },
  {
    ...
    goals: [
      { player: "Gonçalo Ramos", minute: 40, team: "PSG" },
      { player: "Noa Lang", minute: 65, team: "PSV Eindhoven" }
    ],
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Marquinhos", "Pacho", "Nuno Mendes", "Vitinha", "Zaïre-Emery", "Fabián Ruiz", "Dembélé", "Ramos", "Barcola"],
  ...
  },
  {
    ...
    awayTeamImage: teams.atletico,
    score: "1-2",
    venue: "Parc des Princes",
    status: "completed",
    goals: [
      { player: "Ousmane Dembélé", minute: 30, team: "PSG" },
      { player: "Álvaro Morata", minute: 55, team: "Atlético Madrid" },
      { player: "Antoine Griezmann", minute: 80, team: "Atlético Madrid" }
    ],
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Marquinhos", "Pacho", "Nuno Mendes", "Vitinha", "Zaïre-Emery", "Fabián Ruiz", "Dembélé", "Ramos", "Barcola"],
  ...
  },
  {
    ...
    status: "completed",
    goals: [
      { player: "Harry Kane", minute: 60, team: "Bayern Munich" }
    ],
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Marquinhos", "Pacho", "Nuno Mendes", "Vitinha", "Zaïre-Emery", "Fabián Ruiz", "Dembélé", "Ramos", "Barcola"],
      Bayern_Munich: ["Neuer", "Kimmich", "Upamecano", "Kim", "Davies", "Goretzka", "Pavlovic", "Musiala", "Gnabry", "Kane", "Sané"]
    }
  },
  {
    id: 47,
    ...
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Marquinhos", "Pacho", "Nuno Mendes", "Vitinha", "Zaïre-Emery", "Fabián Ruiz", "Dembélé", "Ramos", "Barcola"],
      Red_Bull_Salzburg: ["Blaswich", "Dedić", "Piatkowski", "Bajcetic", "Terzić", "Bidstrup", "Gloukh", "Kjaergaard", "Ratkov", "Nene", "Yeboah"]
    }
  },
  {
    id: 48,
    ...
    goals: [
      { player: "Gonçalo Ramos", minute: 15, team: "PSG" },
      { player: "Erling Haaland", minute: 30, team: "Manchester City" },
      { player: "Ousmane Dembélé", minute: 45, team: "PSG" },
      { player: "Bradley Barcola", minute: 60, team: "PSG" },
      { player: "Phil Foden", minute: 75, team: "Manchester City" },
      { player: "Marco Asensio", minute: 85, team: "PSG" }
    ],
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Marquinhos", "Pacho", "Nuno Mendes", "Vitinha", "Zaïre-Emery", "Fabián Ruiz", "Dembélé", "Ramos", "Barcola"],
  ...
  },
  {
    ...
    goals: [
      { player: "Ousmane Dembélé", minute: 20, team: "PSG" },
      { player: "Gonçalo Ramos", minute: 35, team: "PSG" },
      { player: "Deniz Undav", minute: 50, team: "VfB Stuttgart" },
      { player: "Bradley Barcola", minute: 70, team: "PSG" },
      { player: "Marco Asensio", minute: 85, team: "PSG" }
    ],
    lineup: {
      PSG: ["Donnarumma", "Hakimi", "Marquinhos", "Pacho", "Nuno Mendes", "Vitinha", "Zaïre-Emery", "Fabián Ruiz", "Dembélé", "Ramos", "Barcola"],
      VfB_Stuttgart: ["Nübel", "Vagnoman", "Anton", "Chase", "Mittelstädt", "Karazor", "Stiller", "Millot", "Undav", "Demirović", "Führich"]
    }
  },
  {
    id: 50,
  ...
  },
  {
    ...
    status: "completed",
    goals: [
      { player: "Elliot", minute: 87, team: "PSG" }
    ],
    lineup: {
  ...
  },
  {
    ...
    goals: [
      ...
      { player: " Nuno Mendes", minute: 90+2, team: "PSG" }
    ],
    lineup: {
  ...
  },
  {
    ...
    lineup: {
      ...
      Inter_Milan: ["Sommer", "Pavard", "Acerbi", "Bastoni", "Darmian", "Barella", "Çalh"]}
    },
     {
    id: 59,
    date: "2025-06-15",
