...
const Home = () => {
  ...
  const currentMatches = recentMatches.slice(currentPage * matchesPerPage, (currentPage + 1) * matchesPerPage);
            ...
            {currentMatches.map((match, index) => (
              ...
              >
                <div className="match-card-header">
                  <img src={match.homeTeamImage} alt={`${match.homeTeam} logo`} className="team-logo" />
                  <span className="match-score">{match.score}</span>
                  <img src={match.awayTeamImage} alt={`${match.awayTeam} logo`} className="team-logo" />
                </div>
